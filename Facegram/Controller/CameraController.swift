...
class CameraController: UIViewController,
     UIImagePickerControllerDelegate, UINavigationControllerDelegate, CaptionDelegate {
    ...
    func imagePickerController(picker: UIImagePickerController,
       ...
       selectedImage = info[UIImagePickerControllerEditedImage ] as?
            UIImage
    ...
    func captionController(controller: CaptionController,
        didFinishWithCaption caption: String) {
            ...
            let tabBarController = self.presentingViewController as?
            UITabBarController
             tabBarController!.selectedIndex = 0 //Goes back to feed
